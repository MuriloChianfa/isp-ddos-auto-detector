...
class IsolationForestAnomalyDetector(BaseAnomalyDetector, ModelValidationMixin, ThresholdCalculatorMixin):
    ...
    def analyze_feature_importance(self, data: np.ndarray, 
        ...
        logger.warning("Isolation Forest doesn't provide direct feature importance analysis")
        ...
        print("\nIsolation Forest Feature Analysis:")
        print("=" * 60)
        print("Note: Isolation Forest doesn't provide direct feature importance.")
        print("All features are weighted equally in the ensemble.")
